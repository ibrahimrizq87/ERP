...
@Component({
  selector: 'app-add-expenses-invoices',
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './add-expenses-invoices.component.html',
  styleUrl: './add-expenses-invoices.component.css'
})
export class AddExpensesInvoicesComponent implements OnInit{
  msgError: any[] = [];
  ...
  handleForm() {
    ...
    if (this.expensesForm.valid) {
      ...
      this._InvoiceService.addExpenses(formData).subscribe({
        next: (response) => {
          console.log(response);
          if (response) {
